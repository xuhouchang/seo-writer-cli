...
# 2. crawl + baseline SEO audit (plain HTTP, no key, no LLM)
...
| audit `error` checks | reachability / title / h1 missing | report to the customer as SEO findings, don't paper over |
